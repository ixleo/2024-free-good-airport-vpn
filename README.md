...
- **性价比**直连机场：[最长跑道](https://zcpdao.com/#/register?code=4GTFiwW2)、[CTC2](https://www.ctc.run/#/register?code=mHZErEhf)（目前可能因为被刷邮箱而导致无法注册，大家想注册的话可以先试试，如果不能注册，那就过段时间试试，我这里得到消息会及时更新的）、[十元一年](https://api-1.1010520.click/#/register?code=Ws8LDkKZ)（不考虑稳定性，只考虑性价比的话，这家的确高，但是谁只会考虑性价比呢？）
...
对于大部分用户来说，使用以下列出来的**代理软件**就行（下面的代理软件大部分支持 HY 协议、Vless Reality 协议；没有维护的软件，比如：Clash for Windows 旧版就不支持较新的协议；还有有人维护，但是还不支持新协议的机场，比如Loon、圈X，这类软件将不出现在此推荐表格中。总而言之，推荐使用有人维护的 Clash系、Singbox 系软件。）：
